...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        sahayak: 'Sahayak', sahayakAdmin: 'Sahayak Admin', gramAdmin: 'Gram Admin Portal',
        sahayakLogin: 'Sahayak Login', sahayakImpact: 'Sahayak Impact Report',
        totalCases: 'Total Cases', resolved: 'Resolved', inProgressLabel: 'In Progress',
        reportIncident: 'Report Incident', auditLog: 'Audit Log', incentives: 'Incentives',
        totalEarnings: 'Total Earnings', trustScore: 'Trust Score',
        caseReported: 'Reported', caseInProgress: 'In Progress',
        caseDigitallyResolved: 'Digitally Resolved', casePhysicallyResolved: 'Fully Resolved',
        uploadScreenshot: 'Upload Screenshot', ocrAutoFill: 'OCR will auto-fill details',
        userSatisfied: 'User Satisfied', honorarium: 'Honorarium',
    },
    hi: {
        ...
        sahayak: 'सहायक', sahayakAdmin: 'सहायक प्रशासन', gramAdmin: 'ग्राम प्रशासन पोर्टल',
        sahayakLogin: 'सहायक लॉगिन', sahayakImpact: 'सहायक प्रभाव रिपोर्ट',
        totalCases: 'कुल मामले', resolved: 'हल किया', inProgressLabel: 'प्रगति में',
        reportIncident: 'घटना रिपोर्ट करें', auditLog: 'ऑडिट लॉग', incentives: 'प्रोत्साहन',
        totalEarnings: 'कुल कमाई', trustScore: 'विश्वास स्कोर',
        caseReported: 'रिपोर्ट किया', caseInProgress: 'प्रगति में',
        caseDigitallyResolved: 'डिजिटल रूप से हल', casePhysicallyResolved: 'पूरी तरह हल',
        uploadScreenshot: 'स्क्रीनशॉट अपलोड करें', ocrAutoFill: 'OCR विवरण स्वतः भरेगा',
        userSatisfied: 'उपयोगकर्ता संतुष्ट', honorarium: 'मानदेय',
    },
    bn: {
        ...
        sahayak: 'সহায়ক', sahayakAdmin: 'সহায়ক প্রশাসন', gramAdmin: 'গ্রাম প্রশাসন পোর্টাল',
        sahayakLogin: 'সহায়ক লগইন', sahayakImpact: 'সহায়ক প্রভাব রিপোর্ট',
        totalCases: 'মোট মামলা', resolved: 'সমাধান হয়েছে', inProgressLabel: 'চলমান',
        reportIncident: 'ঘটনা রিপোর্ট করুন', auditLog: 'অডিট লগ', incentives: 'প্রণোদনা',
        totalEarnings: 'মোট আয়', trustScore: 'বিশ্বাস স্কোর',
        caseReported: 'রিপোর্ট করা হয়েছে', caseInProgress: 'চলমান',
        caseDigitallyResolved: 'ডিজিটালভাবে সমাধান', casePhysicallyResolved: 'সম্পূর্ণ সমাধান',
        uploadScreenshot: 'স্ক্রিনশট আপলোড করুন', ocrAutoFill: 'OCR স্বয়ংক্রিয়ভাবে পূরণ করবে',
        userSatisfied: 'ব্যবহারকারী সন্তুষ্ট', honorarium: 'সম্মানী',
    }
};
